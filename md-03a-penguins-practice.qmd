...
3.  How many variables are in the data set? **There are 8 variables in the** `penguins` **dataset.**
4.  How many observations are in the data set? **There are 344 observations in the** `penguins` **dataset.**
...
```{r}
penguins |> 
   # is to handle NA values so flip_max and flip_min doesn't return NA value
